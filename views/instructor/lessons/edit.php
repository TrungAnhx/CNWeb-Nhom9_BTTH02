...
<body>
    ...
    <header class="instructor-header">
        <div class="header-container">
            <div class="header-left">
                <h1 class="logo">✏️ Chỉnh sửa bài học</h1>
            </div>
    ...
    <div class="instructor-container">
        ...
        <div class="breadcrumb">
            ...
            <span> / </span>
            <a href="<?php echo BASE_URL; ?>/?controller=lesson&action=manage&course_id=<?php echo $lesson['course_id']; ?>">
                <?php echo htmlspecialchars($lesson['course_title']); ?>
            </a>
            <span> / </span>
            <span>Chỉnh sửa: <?php echo htmlspecialchars($lesson['title']); ?></span>
        </div>
        ...
        <div class="form-container">
            <form action="<?php echo BASE_URL; ?>/?controller=lesson&action=update&id=<?php echo $lesson['id']; ?>" method="POST" class="lesson-form">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo htmlspecialchars($_SESSION['old_data']['title'] ?? $lesson['title']); ?>"
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="content" 
                                  name="content" 
                                  class="form-control" 
                                  rows="10"><?php echo htmlspecialchars($_SESSION['old_data']['content'] ?? $lesson['content']); ?></textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo htmlspecialchars($_SESSION['old_data']['video_url'] ?? $lesson['video_url']); ?>">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               placeholder="1"
                               min="1"
                               value="<?php echo htmlspecialchars($_SESSION['old_data']['order_num'] ?? $lesson['order_num']); ?>">
                        <small class="form-hint">Thứ tự hiển thị trong danh sách bài học</small>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo BASE_URL; ?>/?controller=lesson&action=manage&course_id=<?php echo $lesson['course_id']; ?>" class="btn btn-secondary">
                        ❌ Hủy bỏ
                    </a>
                </div>
            </form>
