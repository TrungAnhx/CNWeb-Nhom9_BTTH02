...
<body>
    <!-- Header/Sidebar - TODO: Include layout -->
    ...
    <div class="instructor-container">
        ...
        <div class="page-header">
            ...
            <a href="/instructor/courses/create" class="btn-primary">
        ...
        <?php if (empty($courses)): ?>
            ...
            <div class="empty-state">
                ...
                <a href="/instructor/courses/create" class="btn-primary-large">
                ...
                <?php foreach ($courses as $course): ?>
                    <div class="course-card" data-status="<?php echo htmlspecialchars($course['status']); ?>">
                        ...
                        <div class="course-actions">
                            <a href="/instructor/courses/edit/<?php echo $course['id']; ?>" 
                               class="btn-action btn-edit" title="Chỉnh sửa">
                                ✏️ Sửa
                            </a>
                            <a href="/instructor/lessons/manage/<?php echo $course['id']; ?>" 
                               class="btn-action btn-lessons" title="Quản lý bài học">
                                📚 Bài học
                            </a>
                            <a href="/instructor/students/list/<?php echo $course['id']; ?>" 
    ...
    <script>
        ...
        function confirmDelete(courseId, courseTitle) {
            if (confirm(`⚠️ Bạn có chắc muốn xóa khóa học "${courseTitle}"?\n\nThao tác này sẽ xóa toàn bộ bài học và dữ liệu học viên!`)) {
                window.location.href = `/instructor/courses/delete/${courseId}`;
            }
        }
